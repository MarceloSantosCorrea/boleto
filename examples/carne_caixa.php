...
$oAvalista = new \Boleto\Avalista('FRANK BRUNO', '133.567.677-55');

$banco = new \Boleto\Banco\Caixa();
$banco->setCarteiraModalidade('2');
$banco->setCarteira('SR');

$carne = new \Boleto\Carne(
    $banco,
    $oCedente,
    $oSacado,
    $oAvalista
...
while(10 != count($boletosValidacao)) {
    ...
    $parcela = new \Boleto\Carne\Parcela();
...
$loader = new Twig_Loader_Filesystem(\Boleto\Gerador::getDirImages() . '/../templates');
$twig = new Twig_Environment($loader);

$geradorCarne = new \Boleto\GeradorCarne($twig);
